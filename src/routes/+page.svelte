...
<div class="max-w-2xl mx-auto">
	...
	<div class="space-y-4">
		{#each $servers as server}
			<div class="rounded-lg p-4 shadow-md transition-all duration-200 hover:shadow-lg bg-surface">
				<div>
	...
	<div class="mt-4 flex items-center">
		<label class="flex items-center space-x-2">
			<input type="checkbox" bind:checked={rememberSelection} class="form-checkbox" />
