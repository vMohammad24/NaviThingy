...
async function setPresence({
    ...
    const lastfmApiKey = typeof localStorage !== 'undefined' ? localStorage.getItem('lastfm_api_key') : null;
...
function createLastFmStore() {
    const storedValue = typeof localStorage !== 'undefined' ? localStorage.getItem('lastfm_api_key') : null;
...
function createDiscordRPCStore() {
    const storedValue = typeof localStorage !== 'undefined' ?
        localStorage.getItem('discord_rpc_enabled') === 'true' : false;
